...
inline void* operator new(std::size_t count, deegen::TempArenaAllocator& taa)
{
...
inline void* operator new(std::size_t count, std::align_val_t al, deegen::TempArenaAllocator& taa)
{
    TestAssert(deegen::math::is_power_of_2(static_cast<int>(al)));
